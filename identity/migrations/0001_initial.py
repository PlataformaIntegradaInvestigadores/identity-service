    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=identity.models.generate_unique_id,
                        editable=False,
                        max_length=10,
                        primary_key=True,
                        serialize=False,
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        null=True,
                        upload_to=identity.models.get_profile_picture_filepath,
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
                ("is_staff", models.BooleanField(default=False)),
                (
                    "job_recommendations_embedding",
                    models.JSONField(blank=True, null=True),
                ),
                (
                    "feed_recommendations_embedding",
                    models.JSONField(blank=True, null=True),
                ),
                (
                    "profile_vector_updated_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("Positional Voting", "Positional"),
                            ("Non-Positional Voting", "Nonpositional"),
                        ],
                        default="Positional Voting",
                        max_length=50,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="identity.group"
                    ),
                ),
                (
                    "user",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="identity.GroupMembership",
                to="identity.user",
            ),
        ),
